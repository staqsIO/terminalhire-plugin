...
var TERMINALHIRE_DIR3 = process.env.TERMINALHIRE_DIR || join6(homedir3(), ".terminalhire");
var INDEX_CACHE_FILE = join6(TERMINALHIRE_DIR3, "index-cache.json");
function findJobInCache(jobId) {
  try {
    if (!existsSync4(INDEX_CACHE_FILE)) return null;
