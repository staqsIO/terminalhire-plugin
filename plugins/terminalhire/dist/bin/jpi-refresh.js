...
var TERMINALHIRE_DIR6, STATUS_FILE, LOCK_FILE, BAK_FILE;
...
var TERMINALHIRE_DIR8, CLAIMS_FILE, LOCK_DIR, LOCK_STALE_MS, LOCK_RETRY_MS, LOCK_TIMEOUT_MS, PUSHED_CLAIM_FIELDS, TERMINAL_STATES, POLL_TRANSITIONS;
...
async function runBackgroundClaimPush({ now = Date.now() } = {}) {
  try {
    if (!existsSync10(CLAIM_PUSH_AUTO_MARKER) || !existsSync10(CLAIM_PUSH_TOKEN_FILE)) return;
