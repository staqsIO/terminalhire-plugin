...
var init_repo_experience = __esm({
  "src/repo-experience.ts"() {
    ...
    REPO_EXPERIENCE_FILE = join8(TERMINALHIRE_DIR4, "repo-experience.enc");
    MAX_REPOS = 100;
...
var TERMINALHIRE_DIR5, CLAIMS_FILE, LOCK_DIR, LOCK_STALE_MS, LOCK_RETRY_MS, LOCK_TIMEOUT_MS, CLAIM_STATES, CLAIM_TURN_BY_STATE, CLAIM_TURN_LABEL, CLAIM_TURN_LABEL_WIDTH, PUSHED_CLAIM_FIELDS, TERMINAL_STATES, POLL_TRANSITIONS, WHITESPACE_CONTROLS2, CONTROL_CHARS2, DECIDED_STATES;
...
var init_config = __esm({
  "src/config.ts"() {
    ...
    CONFIG_FILE = join10(TERMINALHIRE_DIR6, "config.json");
    DEFAULT_CONFIG = {
      nudge: "session",
      peerConnect: false,
...
function consentFilePath() {
  return join12(terminalhireDir2(), "decline-consent");
}
...
var GH_SESSION_COOKIE, DECLINE_CHOICES;
